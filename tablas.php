...
CREATE TABLE IF NOT EXISTS `lafrips_productos_vendidos_sin_stock` (
  ...
  `id_supplier_solicitar` int(10) NOT NULL,
  `id_employee_cambio_supplier` int(10) NOT NULL,
  `date_cambio_supplier` datetime NOT NULL,
  `id_supply_order` int(10) NOT NULL,
  `id_employee_supply_order` int(10) NOT NULL,
  `date_supply_order` datetime NOT NULL,
  `product_quantity` int(10) NOT NULL,
  `quantity_mod` tinyint(1) NOT NULL,
