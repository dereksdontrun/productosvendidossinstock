...
class AdminPedidosManualesProveedorController extends ModuleAdminController {
    ...
    // función que lee el formulario para obtener los productos de Cerdá y unidades a pedir y genera los archivos necesarios para el pedido, actualizando insertnado en frik_pedidos_cerda
    public function pedidoKaractermania() {
        ...
        //por cada número de input debe haber una referencia de proveedor y una cantidad, metemos la info en un array que enviaremos a la función gestionKaractermaniaManual() de la clase Karactermania
        foreach ($numeros_ids_inputs as $numero_id) {
            ...
            $info_pedido[] = array(
                "referencia_karactermania" => $referencia_proveedor,
                "unidades" => $unidades
            );
        }
    ...
    */
    public function ajaxProcessBuscaProducto(){        
        ...
        if(!$product_supplier[0]['nombre']){ 
            //01/09/2023 Al añdir otro proveedor ya no buscamos en catálogo de Cerdá
